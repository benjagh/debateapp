					...
					<div class="card-body">
						<ul class="w-100 list-group" id="topic-list">
							...
							<li class="list-group-item mb-4">
									...
									<?php if($_SESSION['login_id'] == $row['user_id'] || $_SESSION['login_type'] == 1): ?>
					                    <div class="dropleft float-right mr-4">
					                      ...
					                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					                        ...
					                        <a class="dropdown-item delete_topic" data-id="<?php echo $row['id'] ?>" href="javascript:void(0)">Eliminar</a>
					                      </div>
					                    </div>
				                    <?php endif; ?>
								...
								<p class="row justify-content-left"><span class="badge badge-success text-white"><i>Posteado por : <?php echo $row['name'] ?></i></span></p>
								<hr>
								
								<span class="float-left badge badge-secondary text-white"><?php echo number_format($view) ?> Vistas</span>
								<span class="float-left badge badge-primary text-white ml-2"><i class="fa fa-comments"></i> <?php echo number_format($view) ?> Comentarios <?php echo $replies > 0 ? " and ".number_format($replies).' replies':'' ?> </span>
...
<script>
	...
	$('.delete_topic').click(function(){
		_conf("Estás seguro de eliminar este tema?","delete_topic",[$(this).attr('data-id')],'mid-large')
	})
