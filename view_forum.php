	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				<?php if($_SESSION['login_id'] == $row['user_id'] || $_SESSION['login_type'] == 1): ?>
                    <div class="dropleft float-right mr-4" style="position: relative;">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item delete_topic" data-id="<?php echo $id ?>" href="javascript:void(0)">Eliminar</a>
                      </div>
                    </div>
                <?php endif; ?>
                <span class="float-right mr-4"><small><i><?php echo date('M d, Y h:i A',strtotime($date_created)) ?></i></small></span>
                 <span class="float-right mr-4 text-primary"><small><i>Posteado por: <?php echo ucwords($name) ?></i></small></span>
                 <div class="col-md-8">
				...
				<hr>
				<div class="w-100">
				<span class="badge badge-secondary text-white"><?php echo number_format($view) ?> Vistas</span>
    			...
    			<div class="form-group comment">
                    ...
                    <div class="dropleft float-right">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item delete_comment" data-id="<?php echo $row['id'] ?>" href="javascript:void(0)">Eliminar</a>
                      </div>
                    </div>
                    <?php endif; ?>
    						...
    						<div class="form-group ty-compact-list">
			                    ...
			                    <div class="dropleft float-right">
			                      ...
			                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			                        ...
			                        <a class="dropdown-item delete_reply" data-id="<?php echo $rep['id'] ?>" href="javascript:void(0)">Eliminar</a>
			                      </div>
			                    </div>
			                    <?php endif; ?>
...
<script>
	...
	$('.edit_topic').click(function(){
		uni_modal("Editar categoría","manage_topic.php?id="+$(this).attr('data-id'),'mid-large')
	...
	$('.delete_topic').click(function(){
		_conf("Estás seguro de borrar este tema?","delete_topic",[$(this).attr('data-id')],'mid-large')
	})
    ...
    $('.delete_comment').click(function(){
        _conf("Estás seguro de borrar este comentario?","delete_comment",[$(this).attr('data-id')],'mid-large')
    })
